...
{
    cPParam.positionVec = GetVectorConversion(CourceDataLoader::GetVECTORData(checkPointPosAddress));
    cPParam.directionVec = GetVectorConversion(CourceDataLoader::GetVECTORData(checkPointDirAddress));
